          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class='input-group date' id='from_date'>
                ...
                {!! Form::text('pickup',$data->pickup,['class'=>'form-control']) !!}
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('travellers',__('Number of cars'), ['class' => 'form-label']) !!}
                <input class="form-control" type="number" id="car" name="car" value="{{$data->car}}">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select id="fare_id" name="fare_id" class="form-control" required>
                ...
                @else
                @foreach($fare_selected as $row)
                <option style="color:#f4bc4b;" value="{{$row->intercity_fare_id}}" data-fare="{{$row->fare}}">{{$row->district_name}} , {{$row->upozila_name}} --- <?php
                  $to= DB::table('thana')
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input class="form-control" type="number" id="trip_fare" name="trip_fare" value="{{$data->trip_fare}}" readonly>
            </div>
          </div>
        </div>
        <div class="row">

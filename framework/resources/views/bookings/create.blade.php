    ...
    <div class="card card-success">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('travellers',__('Number of cars'), ['class' => 'form-label']) !!}
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('vehicle_id',__('Select Fare'), ['class' => 'form-label']) !!}
              <select id="fare_id" name="fare_id" class="form-control" required>
                <option value="">-</option>
                @foreach($fare as $row)
                <option value="{{$row->intercity_fare_id}}" data-fare="{{$row->fare}}">{{$row->district_name}} , {{$row->upozila_name}} --- <?php
                  $to= DB::table('thana')
          ...
          <div class="col-md-2">
            <div class="form-group">
              {!! Form::label('travellers',__('Base Fare'), ['class' => 'form-label']) !!}
              <input class="form-control" type="number" id="base_trip_fare" name="base_trip_fare" value="0.00" readonly>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('travellers',__('Total Fare'), ['class' => 'form-label']) !!}

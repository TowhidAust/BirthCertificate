              ...
              @foreach($data as $row)
               <tr>
                ...
                <td style="width: 10% !important">
                  ...
                  {{$row->customer->name}}</br>{{$row->customer->mobno}}
                  @else
                   {{'Customer ID Missing'}}
                   @endif
                </td>
                ...
                <td style="width: 10% !important">{{$row->car}}</td>
                <td style="width: 10% !important"><a target="_blank" href="{{ url('admin/bookings/info/'.$row->id)}}">{{$row->type}}</a></td>
                <td style="width: 10% !important">
                @if($row->status == 1)
                ...
                <td style="width: 10% !important">  {{Hyvikk::get('currency')}} {{$row->return_amount}}</td>
                <td style="width: 10% !important">
                {{Hyvikk::get('currency')}} {{$row->trip_fare}}
                </td>
                <td style="width: 10% !important">
                  <?php $commission_rate=0;$total_commission=0;?>
                    @foreach($fare as $fa)
                    @if($row->trip_fare>=$fa->start&&$row->trip_fare<=$fa->end)
                  <?php
                ...
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    ...
                    data-base_fare_2="{{$row->trip_fare}}"
                    ...
                    data-base_fare_3="{{$row->trip_fare}}"
                    data-base_fare_4="{{$commission_rate}}"
                    data-base_fare_5="{{$total_commission}}"
      ...
      <div class="card card-info">
        ...
        <div class="fleet card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                {!! Form::number('waiting_time',0,['class'=>'form-control sum','min'=>0,'id'=>'base_fare_4']) !!}
                  {!! Form::hidden('total_tax_charge',0,['class'=>'form-control sum','id'=>'total_tax_charge']) !!}
                  {!! Form::hidden('total_tax_charge_rs',0,['class'=>'form-control sum','id'=>'total_tax_charge_rs']) !!}
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label class="form-label">@lang('fleet.total') Charge</label>
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                  <span class="input-group-text">{{Hyvikk::get('currency')}}</span></div>
                  {!! Form::number('tax_total',null,['class'=>'form-control','id'=>'base_fare_5','readonly']) !!}
                </div>
              </div>
            </div>
            <div class="col-md-4">

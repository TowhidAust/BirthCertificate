...
<div class="invoice p-3 mb-3">
  ...
  <form  id="form1" action="{{route('update')}}" method="post" enctype="multipart/form-data">
     {{csrf_field() }}
 <input type="hidden" name="applicant_id" value="{{$id}}">
 <input type="hidden" name="correction_id" value="{{$correction_id}}">
  <div class="row">

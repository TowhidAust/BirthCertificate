@include('frontend.header')
  <section class="mainContents">
    ...
    <div class="sidebarAndContents applicationForm container-custom mt-3">
      ...
      <form  id="form1" action="{{route('application_submit')}}" method="post" enctype="multipart/form-data">
         {{csrf_field() }}

        <div class="Applyform_header d-flex justify-content-between align-items-center">
          <div class="avatarImage">
            <img id="blah" class="img-fluid img-thumbnail" width="200px" height="200px" src="{{asset('assets/images/user.png')}}" alt="avatar">
          </div>

...
<html class="no-js" lang="en">
	...
	<head>
		...
		<link rel="shortcut icon" href="{{asset('fontend/img/favicon.ico')}}" />
		...
		<link rel="stylesheet" href="{{asset('fontend/css/foundation.css')}}">
		<link rel="stylesheet" href="css/foundation-motion-ui.css')}}">

		<!-- Iconic fonts stylesheets-->
		<link rel="stylesheet" href="{{asset('fontend/css/material-design-iconic-font.css')}}">
		<!-- <link rel="stylesheet" href="css/font-awesome.min.css">-->
		<link rel="stylesheet" href="{{asset('fontend/css/renthire-icons.css')}}">
		...
		<div class="off-canvas-wrapper wrapper">
			...
			<div class="off-canvas position-right" id="js-main-off-canvas-right" data-off-canvas data-content-scroll="false" data-auto-focus="false">
				...
				<nav class="mobile-navigation rh-menu" id="js_mobile-menu">
					...
					<ul class="vertical menu" data-drilldown>
						...
						<li><a href="{{route('regular_package')}}">Guest Car</a></li>
					...
					<div class="row">
						...
						<div class="column small-6 medium-4 large-3 topbar-column">
							<div class="button-group align-right align-middle">
								...
								@if(!empty(	$customer_id=Session::get('id')))
								<a class="button secondary-white" href="{{route('custom_logout')}}"><i class="zmdi zmdi-power zmdi-hc-fw"></i></a>
								@else
          ...
          @endphp
					  @if(!empty($profile_pic))
					  	...
					  	<img class="grayscale" src="{{asset('uploads/'.$profile_pic->value)}}" alt="Frank Desmond, general director" style=" border-radius: 50%; height: 59px;width: 59px;margin-bottom: 4px;">
                        </a>
                        @else
                	 <a href="{{route('user_profile')}}">
                        <img class="grayscale" src="{{asset('fontend/img/fleet/m.jpg')}}" alt="Frank Desmond, general director"style=" border-radius: 50%; height: 59px;width: 59px;margin-bottom: 4px;">
                        </a>
                        @endif
					@endif
								<!-- <div class="icon-box border circle small">
									<a href="{{route('user_profile')}}">
										<img class="grayscale" src="{{asset('/fontend/img/fleet/mm.png')}}" alt="Frank Desmond, general director" style=" border-radius: 50%; height: 59px;width: 59px;margin-bottom: 4px;">
									</a>
								</div> -->
							...
							<div class="column shrink">
								...
								<div class="site-header-logo logo-container">
									<a href="{{url('/')}}">
										...
										<img src='{{asset('fontend/img/logo.svg')}}' class="secondary" alt='"Renthire" - html5 template'>
										<!-- <svg class="secondary">
							...
							<div class="column flex-child-grow">
								...
								<nav class="site-navigation show-for-large">
									<ul class="main-menu menu dropdown" data-dropdown-menu data-hover-delay="300">
										<li><a href="{{route('index')}}">Home</a></li>
										<li><a href="{{route('wedding')}}">Wedding</a></li>
										<li><a href="{{route('regular_package')}}">Guest Cars</a></li>
										<li><a href="{{route('package')}}">Package</a></li>
										<li><a href="{{route('contact')}}">Contact</a></li>
									</ul><!-- /end .main-menu -->

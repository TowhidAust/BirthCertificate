    ...
    <div class="sidebarHeading">
        ...
        <div class="sidebarLinks d-flex flex-column justify-content-center">
            <ul><li><a href="{{route('birthki')}}">জন্ম নিবন্ধন কি</a></li></ul>
            <ul><li><a href="{{route('bid_use')}}">জন্ম নিবন্ধন কি কাজে লাগে</a></li></ul>
            <ul><li><a href="{{route('process_of_apply')}}">আবেদন প্রক্রিয়া</a></li></ul>
            <ul><li><a href="{{route('information_supplier')}}">জন্ম তথ্য প্রদানকারী</a></li></ul>
            <ul><li><a href="{{route('b_d_registration_center')}}">জন্ম ও মৃত্যু নিবন্ধন কোথায় করবেন</a></li></ul>
            <ul><li><a href="{{route('list_of_center')}}">বরিশাল সিটি কর্পোরেশন এর জন্ম ও মৃত্যু নিবন্ধন কার্যালয়ের তালিকা</a></li></ul>
        </div>
    </div>
    <div class="sidebarHeading">
        <h4 class="text-center bg-primary rounded p-2 text-light">মৃত্যু নিবন্ধন সংক্রান্ত তথ্য</h4>
        <div class="sidebarLinks d-flex flex-column justify-content-center">
            <ul><li><a href="{{route('mrittuki')}}">মৃত্যু নিবন্ধন কি</a></li></ul>
            <ul><li><a href="{{route('mrittuneed')}}">মৃত্যু নিবন্ধন কি কাজে লাগে</a></li></ul>
            <ul><li><a href="{{route('mrittuapp')}}">আবেদন প্রক্রিয়া</a></li></ul>
            <ul><li><a href="{{route('mrittuinf')}}">মৃত্যু তথ্য প্রদানকারী</a></li></ul>
        </div>
    </div>
    <div class="sidebarHeading">
    ...
    <!-- <div class="sidebarHeading">
         <h4 class="text-center bg-primary rounded p-2 text-light">জন্ম নিবন্ধন সংক্রান্ত তথ্য</h4>
        <div class="sidebarLinks d-flex flex-column justify-content-center">
            <a href="{{route('sidebarDetails')}}">জন্ম নিবন্ধন কি</a>
            <a href="{{route('sidebarDetails')}}">জন্ম নিবন্ধন কি কাজে লাগে</a>
            <a href="{{route('sidebarDetails')}}">আবেদন প্রক্রিয়া</a>
        </div>
    </div>
    <div class="sidebarHeading">
        <h4 class="text-center bg-primary rounded p-2 text-light">জন্ম নিবন্ধন সংক্রান্ত তথ্য</h4>

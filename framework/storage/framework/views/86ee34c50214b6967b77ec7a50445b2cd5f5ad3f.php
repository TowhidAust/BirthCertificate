          ...
          <div class="col-md-12">
            <div class="card card-success">
              ...
              <div class="card-body">
                ...
                <?php endif; ?>
                <?php echo Form::open(['route' => 'thana.store','method'=>'post','class'=>'row','files'=>true]); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-6">
                        <div class="input-group">
                          <input required="required" name="thana" type="text" id="tax_charge_rs" class="form-control">
                        </div>
                      </div>
                    </div>
                  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/location/thana.blade.php ENDPATH**/ ?>
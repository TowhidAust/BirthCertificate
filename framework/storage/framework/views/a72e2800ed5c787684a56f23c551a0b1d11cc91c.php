...
<?php echo Form::open(['route' => 'intercity.fare.store','method'=>'post','class'=>'row','files'=>true]); ?>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <select id="districtto" name="districtto" class="form-control vehicles dynamicto_district" data-dependent="thanato" required style="width: 100%">
                    <option value="">Select District</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="input-group">
                    ...
                    <input required="required" name="fare" type="text"  class="form-control" min="0">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="input-group">
                    <div class="input-group-prepend">
                    <span class="input-group-text">TK</span></div>
                    <input required="required" name="return_extra_fare" type="text"  class="form-control" min="0">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="panel-heading">
          <div class="row">
            ...
            <div class="col-md-2" style="text:align:right;">
              <a href="<?php echo e(route('delete.all_fare')); ?>">  <button style="float:right;" onclick="myFunction()"  class="btn btn-danger">Delete All Fare </button></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Import Interciy Fare</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <?php echo Form::open(['url'=>'admin/import-fare','method'=>'POST','files'=>true]); ?>

        <div class="form-group">
          <?php echo Form::label('excel',__('Interciy Fare'),['class'=>"form-label"]); ?>

          <?php echo Form::file('excel',['class'=>"form-control",'required']); ?>

        </div>
        <div class="form-group">
          <a href="<?php echo e(asset('assets/samples/intercity_fare.xlsx')); ?>"><?php echo app('translator')->getFromJson('fleet.downloadSampleExcel'); ?></a>
        </div>
        <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/fare/intercity.blade.php ENDPATH**/ ?>
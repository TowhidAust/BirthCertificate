  ...
  <div class="col-md-12">
    <div class="card card-success">
      ...
      <div class="card-body">
        ...
        <?php endif; ?>
        <?php echo Form::open(['route' => 'district.update','method'=>'post','class'=>'row','files'=>true]); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <select id="division" name="division" class="form-control vehicles dynamic" data-dependent="district" required style="width: 100%">
                  <option value="<?php echo e($edit_district->state_id); ?>"><?php echo e($edit_district->state_name); ?></option>
            ...
            <div class="form-group">
              ...
              <div class="col-xs-6">
                <div class="input-group">
                  <input required="required" name="id" type="hidden" id="tax_charge_rs" value="<?php echo e($edit_district->city_id); ?>" class="form-control">
                  <input required="required" name="district_name" type="text" id="tax_charge_rs" value="<?php echo e($edit_district->city_name); ?>" class="form-control">
                </div>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\car\framework\resources\views/location/district_edit.blade.php ENDPATH**/ ?>
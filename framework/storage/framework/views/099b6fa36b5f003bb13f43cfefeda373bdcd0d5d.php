  ...
  <div class="col-md-12">
    <div class="card card-success">
      ...
      <div class="card-body">
        ...
        <form class="" action="<?php echo e(route('tour.package.update')); ?>" method="post" enctype="multipart/form-data">
      <?php echo e(csrf_field()); ?>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <?php echo Form::label('last_name', __(' Package Price'), ['class' => 'form-label']); ?>
            ...
            <div class="form-group">
              <?php echo Form::label('profile_image', __('Facebook Post Link'), ['class' => 'form-label']); ?>


              <textarea class="form-control" rows="8" cols="80" name="fb_link">
                  <?php echo e($data->fb_link); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/package/edit_tour.blade.php ENDPATH**/ ?>
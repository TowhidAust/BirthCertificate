      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tr>
            ...
            <td> <?php echo e(Hyvikk::get('currency')); ?> <?php echo e(number_format($booking->total, 2)); ?></td>
          </tr>
          <!-- <tr>
          ...
          <tr>
            <th><?php echo app('translator')->getFromJson('fleet.total'); ?> Amount:</th>
            <td><?php echo e(Hyvikk::get('currency')); ?> <?php echo e(number_format($i->booking_income->amount, 2)); ?></td>
          </tr>
        </table>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BirthCertificate\framework\resources\views/bookings/receipt.blade.php ENDPATH**/ ?>
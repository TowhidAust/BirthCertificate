...
<?php echo Form::open(['route' => 'commission.update','method'=>'post','class'=>'row','files'=>true]); ?>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <?php echo Form::label('', __('Start'), ['class' => 'col-xs-12 control-label']); ?>

                <div class="col-md-12">
                  <div class="input-group">
                    <div class="input-group-prepend"></div>
                    <input required="required" value="<?php echo e($edit_data->start); ?>" name="start" type="text"  class="form-control" min="0">
                    <input required="required" value="<?php echo e($edit_data->id); ?>" name="id" type="hidden"  class="form-control" min="0">
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <?php echo Form::label('', __('End'), ['class' => 'col-xs-12 control-label']); ?>

                <div class="col-md-12">
                  <div class="input-group">
                    <div class="input-group-prepend"></div>
                    <input required="required" value="<?php echo e($edit_data->end); ?>" name="end" type="text"  class="form-control" min="0">
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <?php echo Form::label('', __('Commission (%)'), ['class' => 'col-xs-12 control-label']); ?>

                <div class="col-md-12">
                  <div class="input-group">
                    <div class="input-group-prepend">
                    <span class="input-group-text">%</span></div>
                    <input required="required" value="<?php echo e($edit_data->commission); ?>" name="commission" type="text"  class="form-control" min="0">
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4" style=" margin-top: 29px;">
              <button type="submit" class="btn btn-success">Update Commission</button>
            </div>
           </div>
         </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/fare_commision/edit.blade.php ENDPATH**/ ?>
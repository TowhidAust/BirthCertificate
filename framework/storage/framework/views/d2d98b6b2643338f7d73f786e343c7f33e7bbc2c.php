            ...
            <tbody>
              <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <tr>
                ...
                <td style="width: 10% !important">
                  <?php if($row->getMeta('waiting_time')): ?>
                  <?php echo e($row->getMeta('waiting_time')); ?> %
                  <?php endif; ?>
                </td>
                <td style="width: 10% !important">
                <?php if($row->receipt == 1): ?>
                <?php echo e(Hyvikk::get('currency')); ?>  <?php
                  $charge= DB::table('income')
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\car\framework\resources\views/bookings/index.blade.php ENDPATH**/ ?>
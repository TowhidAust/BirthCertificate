      ...
      <?php echo e(csrf_field()); ?>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <?php echo Form::label('last_name', __('Price'), ['class' => 'form-label']); ?>
            ...
            <div class="form-group">
              ...
              <select id="group_id" name="type" class="form-control">
                ...
                <option value="0" selected>Wedding Package</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\car\framework\resources\views/package/create.blade.php ENDPATH**/ ?>
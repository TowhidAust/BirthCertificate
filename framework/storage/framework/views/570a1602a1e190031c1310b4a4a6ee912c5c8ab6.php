...
<?php echo Form::open(['route' => 'fare.commission.store','method'=>'post','class'=>'row','files'=>true]); ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="input-group">
                    ...
                    <input required="required" name="start" type="text"  class="form-control" min="0">
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="input-group">
                    <div class="input-group-prepend"></div>
                    <input required="required" name="end" type="text"  class="form-control" min="0">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="input-group">
                    ...
                    <input required="required" name="commission" type="text"  class="form-control" min="0">
                  </div>
                </div>
              </div>
            </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                    ...
                    <?php echo Form::open(['route' => 'fare.commission.edit','method'=>'post','files'=>true]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/fare_commision/index.blade.php ENDPATH**/ ?>
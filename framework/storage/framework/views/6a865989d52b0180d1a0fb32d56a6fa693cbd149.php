...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('Packages'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('Manage Packages'); ?> &nbsp; <a href="<?php echo e(route("package.create")); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('Add Packages'); ?></a></h3>
      </div>
        ...
        <table class="table" id="data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('Real Rent'); ?></th>
              <th><?php echo app('translator')->getFromJson('Artificial Rent'); ?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              <?php if($row->image): ?>
              <img src="<?php echo e(asset('uploads/'.$row->image)); ?>" height="80px" width="80px">
              <?php else: ?>
              ...
              <td><?php echo e(number_format($row->ar_price,2)); ?></td>
              <td><?php echo e($row->description); ?></td>
              <td><?php echo e(date($date_format_setting.' g:i A',strtotime($row->create_at))); ?></td>
              <td>
              <div class="btn-group">
              ...
              <div class="dropdown-menu custom" role="menu">
                ...
                <?php echo Form::open(['route' => 'package.edit','method'=>'get','files'=>true]); ?>
              ...
              <?php echo Form::open(['route' => 'package.delete','method'=>'post','files'=>true]); ?>
              ...
              <?php echo Form::open(['url' => 'package/users/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/package/index.blade.php ENDPATH**/ ?>
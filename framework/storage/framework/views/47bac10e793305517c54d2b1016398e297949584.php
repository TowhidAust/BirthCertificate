          ...
          <div class="col-md-12">
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title"><?php echo app('translator')->getFromJson('Update Record'); ?></h3>
              </div>
              <div class="card-body">
                <?php ($tax_percent=0); ?>
                ...
                <?php endif; ?>
                <?php echo Form::open(['route' => 'thana.update','method'=>'post','class'=>'row','files'=>true]); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <select id="division" name="division" class="form-control vehicles dynamic" data-dependent="district" required style="width: 100%">
                            <option value="<?php echo e($edit_thana->state_id); ?>"><?php echo e($edit_thana->state_name); ?></option>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <select id="district" name="district" class="form-control vehicles dynamic_district" data-dependent="thana" required style="width: 100%">
                          <option value="<?php echo e($edit_thana->city_id); ?>"><?php echo e($edit_thana->city_name); ?></option>
                        </select>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <?php echo Form::label('tax_charge_rs', __('')." ". __('Thana'), ['class' => 'col-xs-5 control-label']); ?>

                      <div class="col-xs-6">
                        <div class="input-group">
                          <input required="required" name="id" type="hidden" id="tax_charge_rs" class="form-control" value="<?php echo e($edit_thana->id); ?>">
                          <input required="required" name="thana" type="text" id="tax_charge_rs" class="form-control" value="<?php echo e($edit_thana->upozila_name); ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3" style=" margin-top: 29px;">
                    <button type="submit" class="btn btn-success"><?php echo app('translator')->getFromJson('Update'); ?></button>
                  </div>
                  <?php echo Form::close(); ?>
        ...
        <table class="table" id="data_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              <?php if($row->upozila_name != null): ?>
              <?php echo e($row->upozila_name); ?>
              ...
              <td>
                    ...
                    <?php echo Form::open(['route' => 'thana_edit','method'=>'post','files'=>true]); ?>
                    ...
                    <?php echo Form::open(['route' => 'thana.delete','method'=>'post','files'=>true]); ?>
...
$(document).ready(function() {
  ...
  $('#vehicle_id').select2({placeholder: "Select District"});
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/location/thana_edit.blade.php ENDPATH**/ ?>
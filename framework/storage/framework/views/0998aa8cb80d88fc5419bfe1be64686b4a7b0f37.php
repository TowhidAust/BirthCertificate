  ...
  <div class="col-md-12">
    <div class="card card-success">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <?php echo Form::open(['route' => 'division.modify','method'=>'post','files'=>true]); ?>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <input type="hidden" name="id" value="<?php echo e($edit_data->state_id); ?>" required>
                <input class="form-control" type="text" name="division_name" value="<?php echo e($edit_data->state_name); ?>" required>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\car\framework\resources\views/location/division_edit.blade.php ENDPATH**/ ?>
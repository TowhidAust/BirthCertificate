...
<li class="breadcrumb-item active"><?php echo app('translator')->getFromJson('Application'); ?> <?php echo app('translator')->getFromJson('fleet.report'); ?></li>
<?php $__env->stopSection(); ?>
...
<div class="row">
  <div class="col-md-12">
    <div class="card card-info">
      ...
      <div class="card-body">
        <?php echo Form::open(['route' => 'applicaton_report_post','method'=>'post','class'=>'form-inline']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BirthCertificate\framework\resources\views/reports/application.blade.php ENDPATH**/ ?>
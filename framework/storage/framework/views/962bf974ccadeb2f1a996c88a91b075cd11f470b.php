			...
			<div class="off-canvas position-right" id="js-main-off-canvas-right" data-off-canvas data-content-scroll="false" data-auto-focus="false">
				...
				<nav class="mobile-navigation rh-menu" id="js_mobile-menu">
					...
					<ul class="vertical menu" data-drilldown>
						...
						<li><a href="<?php echo e(route('regular_package')); ?>">Packages</a></li>
							...
							<div class="button-group align-right align-middle">
								...
								<div class="langbar" id="js-langbar">
									...
									<div class="dropdown-pane rh-menu" id="js-langbar-menu" data-dropdown data-close-on-click="true" data-hover="true" data-hover-pane="true">
										...
										<ul class="menu vertical">
											<li>
												<a href="#" data-lang="bn" data-flag="bd">
													<span class="icon flag-icon flag-icon-bd"></span>
								...
								<div class="icon-box border circle small">
									<a href="<?php echo e(route('user_profile')); ?>">
										<img class="grayscale" src="http://localhost/car/fontend/img/fleet/m.jpg" alt="Frank Desmond, general director" style=" border-radius: 50%; height: 59px;width: 59px;margin-bottom: 4px;">
									</a>
								</div>
...
<?php /**PATH C:\xampp\htdocs\car\framework\resources\views/frontend/header.blade.php ENDPATH**/ ?>
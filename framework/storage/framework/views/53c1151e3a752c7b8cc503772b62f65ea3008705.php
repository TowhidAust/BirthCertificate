        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="radio" name="gender" class="flat-red gender" value="1" <?php if($data->gender == 1): ?> checked <?php endif; ?> required> <?php echo app('translator')->getFromJson('fleet.male'); ?><br>
              <input type="radio" name="gender" class="flat-red gender" value="0" <?php if($data->gender == 0): ?> checked <?php endif; ?> required> <?php echo app('translator')->getFromJson('fleet.female'); ?>
            </div>
          </div>
        </div>
        <div class="col-md-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/customers/edit.blade.php ENDPATH**/ ?>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->getFromJson('Manage Packages'); ?> &nbsp; <a href="<?php echo e(route("package.tour_create")); ?>" class="btn btn-success"><?php echo app('translator')->getFromJson('Add Packages'); ?></a></h3>
      </div>
        ...
        <table class="table" id="data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th><?php echo app('translator')->getFromJson('Facebook Link'); ?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <div class="dropdown-menu custom" role="menu">
                ...
                <?php echo Form::open(['route' => 'tour.package.edit','method'=>'get','files'=>true]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/package/tour_package.blade.php ENDPATH**/ ?>
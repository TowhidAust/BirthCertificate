...
<div class="wrapper">
      ...
      <nav class="mt-2">
        ...
        <?php if(!Auth::guest() &&  Auth::user()->user_type!="D" && Auth::user()->user_type != "C" ): ?>
          ...
          <?php if(in_array(1,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('vehicles.index')); ?>" class="nav-link <?php if(Request::is('admin/vehicles*')): ?> active <?php endif; ?>">
                  <i class="fa fa-truck nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('menu.manageVehicles'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('vehicle-types.index')); ?>" class="nav-link <?php if(Request::is('admin/vehicle-types*')): ?> active <?php endif; ?>">
                  <i class="fa fa-th-list nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.manage_vehicle_types'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(url('admin/driver-logs')); ?>" class="nav-link <?php if(Request::is('admin/driver-logs*')): ?> active <?php endif; ?>">
                  <i class="fa fa-history nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.driver_logs'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('vehicle_group.index')); ?>" class="nav-link <?php if(Request::is('admin/vehicle_group*')): ?> active <?php endif; ?>">
                  <i class="fa fa-inbox nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.manageGroup'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(url('admin/vehicle-reviews')); ?>" class="nav-link <?php if((Request::is('admin/vehicle-reviews*')) || (Request::is('admin/view-vehicle-review*')) || (Request::is('admin/vehicle-review*'))): ?> active <?php endif; ?>">
          ...
          <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('division')); ?>" class="nav-link <?php if((Request::is('admin/division'))|| (Request::is('admin/division'))): ?> active <?php endif; ?>">
                  <i class="fa fa-map"></i>
                  <p>Division</p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('district')); ?>" class="nav-link <?php if((Request::is('admin/district')) || (Request::is('admin/district'))): ?> active <?php endif; ?>">
                  <i class="fa fa-map"></i>
                  <p>District</p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('thana')); ?>" class="nav-link <?php if((Request::is('admin/thana')) || (Request::is('admin/thana'))): ?> active <?php endif; ?>">
                  <i class="fa fa-map"></i>
                  <p>Thana</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('fare.commision')); ?>" class="nav-link <?php if((Request::is('admin/intercity'))|| (Request::is('admin/intercity'))): ?> active <?php endif; ?>">
                  <i class="fa fa-money"></i>
                  <p>Fare Commision</p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('intercity')); ?>" class="nav-link <?php if((Request::is('admin/intercity'))|| (Request::is('admin/intercity'))): ?> active <?php endif; ?>">
                  <i class="fa fa-money"></i>
                  <p>Intercity</p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('package.index')); ?>" class="nav-link <?php if((Request::is('admin/package.index')) || (Request::is('admin/district'))): ?> active <?php endif; ?>">
                  <i class="fa fa-money"></i>
                  <p> Wedding</p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('guest.fare.index')); ?>" class="nav-link <?php if((Request::is('admin/guest-fare')) || (Request::is('admin/thana'))): ?> active <?php endif; ?>">
                  <i class="fa fa-money"></i>
                  <p>Guest Car Fare</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('tour.package.index')); ?>" class="nav-link <?php if((Request::is('admin/guest-fare')) || (Request::is('admin/thana'))): ?> active <?php endif; ?>">
                  <i class="fa fa-money"></i>
                  <p>Package</p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('color')); ?>" class="nav-link <?php if((Request::is('admin/color')) || (Request::is('admin/thana'))): ?> active <?php endif; ?>">
          ...
          <!-- <?php if(in_array(5,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('fuel.create')); ?>" class="nav-link <?php if(Request::is('admin/fuel/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-plus-square nav-icon"></i>
                  <p> <?php echo app('translator')->getFromJson('fleet.add_fuel'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('fuel.index')); ?>" class="nav-link <?php if(Request::is('admin/fuel*') && !Request::is('admin/fuel/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-history nav-icon"></i>
          ...
          <!-- <?php if(in_array(6,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('vendors.create')); ?>" class="nav-link <?php if(Request::is('admin/vendors/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-plus-square nav-icon"></i>
                  <p> <?php echo app('translator')->getFromJson('fleet.add_vendor'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('vendors.index')); ?>" class="nav-link <?php if((Request::is('admin/vendors*') && !(Request::is('admin/vendors/create')))): ?> active <?php endif; ?>">
           ...
           <!-- <?php if(in_array(14,$modules)): ?><li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('parts.create')); ?>" class="nav-link <?php if(Request::is('admin/parts/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-plus-square nav-icon"></i>
                  <p> <?php echo app('translator')->getFromJson('fleet.addParts'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('parts.index')); ?>" class="nav-link <?php if(Request::is('admin/parts*') && !(Request::is('admin/parts-category*')) && !Request::is('admin/parts/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-gears nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('menu.manageParts'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('parts-category.index')); ?>" class="nav-link <?php if(Request::is('admin/parts-category*')): ?> active <?php endif; ?>">
          ...
          <!-- <?php if(in_array(7,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('work_order.create')); ?>" class="nav-link <?php if(Request::is('admin/work_order/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-plus-square nav-icon"></i>
                  <p> <?php echo app('translator')->getFromJson('fleet.add_order'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('work_order.index')); ?>" class="nav-link <?php if((Request::is('admin/work_order*')) && !(Request::is('admin/work_order/create')) && !(Request::is('admin/work_order/logs')) || Request::is('admin/parts-used*')): ?> active <?php endif; ?>">
                  <i class="fa fa-inbox nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.manage_work_order'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(url('admin/work_order/logs')); ?>" class="nav-link <?php if(Request::is('admin/work_order/logs')): ?> active <?php endif; ?>">
                  <i class="fa fa-history nav-icon"></i>
          ...
          <?php if(in_array(9,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('service-reminder.index')); ?>" class="nav-link <?php if(Request::is('admin/service-reminder')): ?> active <?php endif; ?>">
                  <i class="fa fa-arrows-alt nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.manage_reminder'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('service-reminder.create')); ?>" class="nav-link <?php if(Request::is('admin/service-reminder/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-check-square-o nav-icon"></i>
                  <p><?php echo app('translator')->getFromJson('fleet.add_service_reminder'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('service-item.index')); ?>" class="nav-link <?php if(Request::is('admin/service-item*')): ?> active <?php endif; ?>">
          ...
          <?php if(in_array(15,$modules)): ?> <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('testimonials.index')); ?>" class="nav-link <?php if((Request::is('admin/testimonials*') && !(Request::is('admin/testimonials/create')))): ?> active <?php endif; ?>">
                  <i class="fa fa-tasks nav-icon"></i>
                  <p> <?php echo app('translator')->getFromJson('fleet.manage_testimonial'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route("testimonials.create")); ?>" class="nav-link <?php if(Request::is('admin/testimonials/create')): ?> active <?php endif; ?>">
                  <i class="fa fa-plus-square nav-icon"></i>
          ...
          <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route('team.index')); ?>" class="nav-link <?php if((Request::is('admin/team*') && !(Request::is('admin/team/create')))): ?> active <?php endif; ?>">
                  <i class="fa fa-tasks nav-icon"></i>
                  <p> <?php echo app('translator')->getFromJson('fleet.manage_team'); ?></p>
                </a>
              </li>
              <li class="nav-item">
                <a style="margin-left: 23px;" href="<?php echo e(route("team.create")); ?>" class="nav-link <?php if(Request::is('admin/team/create')): ?> active <?php endif; ?>">
  ...
  <footer class="main-footer">
    <strong><?php echo app('translator')->getFromJson('fleet.copyright'); ?> &copy; 2016-<?php echo e(date("Y")); ?> <a href="https://infobizsoftware.com/">InfobizSoftware</a>.</strong>
...
<?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/layouts/app.blade.php ENDPATH**/ ?>
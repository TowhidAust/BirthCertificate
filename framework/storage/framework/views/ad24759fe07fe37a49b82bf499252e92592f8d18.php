          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class='input-group date' id='from_date'>
                ...
                <?php echo Form::text('pickup',$data->pickup,['class'=>'form-control']); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <?php echo Form::label('travellers',__('Number of cars'), ['class' => 'form-label']); ?>
                ...
                <input class="form-control" type="number" id="car" name="car" value="<?php echo e($data->car); ?>">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select id="fare_id" name="fare_id" class="form-control" required>
                <?php if($data->type=="Wedding"): ?>
                  <option value="00"> Wedding Package </option>
                <?php elseif($data->type=="Package"): ?>
                  <option value="00">  Package </option>
                <?php else: ?>
                <?php $__currentLoopData = $fare_selected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option style="color:#f4bc4b;" value="<?php echo e($row->intercity_fare_id); ?>" data-fare="<?php echo e($row->fare); ?>"><?php echo e($row->district_name); ?> , <?php echo e($row->upozila_name); ?> --- <?php
                  $to= DB::table('thana')
                              ...
                              ->get() ;
                    foreach ($to as  $value) {
                      echo $value->district_name.' , '.$value->upozila_name.' ( '.$row->displayname.'  ) = '.$row->fare;
                  }
                 ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php endif; ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input class="form-control" type="number" id="trip_fare" name="trip_fare" value="<?php echo e($data->trip_fare); ?>" readonly>
            </div>
          </div>
        </div>
        <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/bookings/edit.blade.php ENDPATH**/ ?>
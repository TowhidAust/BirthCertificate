						...
						<div class="column small-12 medium-7 large-4 large-order-2 text-center">
							...
							<div class="logo-container">
								<a href="index.html">
									...
									<img src='<?php echo e(asset('assets/images/'.Hyvikk::get('logo_img'))); ?>' alt='"Renthire" - html5 template'>
								</a>
							</div>

							<div class="site-footer-section no-border">
								<img src="img/vehicle-range.png" alt="">
								<small><?php echo e(Hyvikk::frontend('about_us')); ?></small>
							...
							<div class="site-footer-section no-border">
								<ul class="no-bullet">
									<li>
										...
										<button class="block-link" type="button" data-open="js-map-fullscreen"><?php echo e(Hyvikk::get('badd2')); ?></button>
									</li>
									<li>
										<i class="zmdi-hc-fw zmdi zmdi-phone fa-fw fa fa-phone"></i>
										<a class="phone block-link" href="tel:YourPhoneNumber"><?php echo e(Hyvikk::frontend('customer_support')); ?></a>
									</li>
									<li>
										<i class="zmdi-hc-fw zmdi zmdi-email fa-fw fa fa-envelope"></i>
										<a class="mail block-link" href="<?php echo e(Hyvikk::frontend('contact_email')); ?>"><?php echo e(Hyvikk::frontend('contact_email')); ?></a>
									</li>
								</ul>
							</div><!-- /end .site-footer-section -->
							...
							<div class="site-footer-section no-border">
								<div class="button-group socials  align-center">
									<a class="button hollow secondary-white" href="<?php echo e(Hyvikk::frontend('facebook')); ?>"><i class="zmdi zmdi-facebook fa fa-facebook icon"></i></a>
									<a class="button hollow secondary-white" href="<?php echo e(Hyvikk::frontend('contact_email')); ?>"><i class="zmdi zmdi-google fa fa-google icon"></i></a>
									<a class="button hollow secondary-white" href="<?php echo e(Hyvikk::frontend('linkedin')); ?>"><i class="zmdi zmdi-linkedin fa fa-linkedin icon"></i></a>
									<a class="button hollow secondary-white" href="<?php echo e(Hyvikk::frontend('instagram')); ?>"><i class="zmdi zmdi-instagram fa fa-instagram icon"></i></a>
								</div>
							</div><!-- /end .site-footer-section -->
...
<script src="<?php echo e(asset('fontend/js/vendor/animsition.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/foundation.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/what-input.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/owl.carousel.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/shuffle.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/inputmask.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/inputmask.phone.extensions.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/lightcase.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/jquery.waypoints.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/jquery.incremental-counter.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/slick.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/jquery.barrating.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/jquery.countdown.min.js')); ?>"></script>
<script src="<?php echo e(asset('fontend/js/vendor/flatpickr.min.js')); ?>"></script>
<!-- <script src="<?php echo e(asset('fontend/js/vendor/imagesloaded.pkgd.min.js')); ?>"></script> -->
...
<?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/frontend/footer.blade.php ENDPATH**/ ?>
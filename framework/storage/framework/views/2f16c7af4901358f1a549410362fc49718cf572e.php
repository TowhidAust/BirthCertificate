        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" rows="8" cols="80" name="fb_link"></textarea>
            </div>
            <div class="form-group">
              <?php echo Form::label('profile_image', __('Description'), ['class' => 'form-label']); ?>


              <textarea class="form-control" rows="8" cols="80" name="description"></textarea>
            </div>
          </div>
          <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rental\framework\resources\views/package/create_tour.blade.php ENDPATH**/ ?>